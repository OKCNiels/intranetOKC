...
@section('content')
    <div class="page-header">
        <h1 class="page-title">Control de Guías de Remisión</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Control</a></li>
                <li class="breadcrumb-item active" aria-current="page">Guías de Remisión</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Lista de guías de remisión</h3>
                </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_emision_guia" class="form-control" id="" placeholder="">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_despacho_real" class="form-control" id="" placeholder="Username">
                                </div>
                            </div>
                        </div>
                        {{-- ----------------------------- --}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group text-center">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input class="form-control datepicker-date text-center"  placeholder="Fecha desde" type="text" name="fecha_inicio" data-select="change" data-seccion="fecha_inicio" disabled>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group text-center">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input class="form-control datepicker-date text-center"  placeholder="Fecha Hasta" type="text" name="fecha_final" data-select="change" data-seccion="fecha_final" disabled>
...
@section('scripts')
    ...
    <!-- INTERNAL Bootstrap-Datepicker js-->
    <script src="{{ asset('template/plugins/bootstrap-datepicker/bootstrap-datepicker.js') }}"></script>
    <script src="{{ asset('template/plugins/bootstrap-datepicker/lenguaje.js') }}"></script>
    ...
    <script src="{{ asset('admin/js/extranet/guias.js') }}"></script>

    <script src="{{ asset('admin/js/extranet/guias/guias-model.js') }}"></script>
    <script src="{{ asset('admin/js/extranet/guias/guias-view.js') }}"></script>
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).ready(function() {
            const view = new GuiasView(new GuiasModel(csrf_token));
            // view.listar();
            view.eventos();
        });
        });
