...
function listar() {
    ...
    const $tabla = $('#tabla').DataTable({
        ...
        buttons: [
            {
                text: '<i class="fe fe-filter"></i> Filtros',
                action: function () {
            ...
            {
                text: '<i class="fe fe-plus"></i> Agregar GR',
                action: function () {
                    $("#formulario")[0].reset();
                    $('[name=id]').val(0);
            ...
            {
                text: '<i class="fe fe-layers"></i> Agregar GR Automatico',
                action: function () {
                    $("#formulario-masivo")[0].reset();
            ...
            {
                text: '<i class="fa fa-file-excel-o"></i> Reporte',
                action: function () {
                    // $("#formulario-masivo")[0].reset();
                    // $("#modalRegistroMasivo").modal("show");
...
function archivarGuia(almacen, logistica) {
    ...
    //     data: { _token: csrf_token, valor: valor},
    //     dataType: "JSON",
    //     success: function (response) {
    //         if (response.respuesta == 'ok') {
