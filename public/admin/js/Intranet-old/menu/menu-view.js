class MenuView {
    ...
    listar = () => {
        const $tabla = $('#tabla-data').DataTable({
            ...
            order: [[0, 'asc']],
            ajax: {
                url: route('panel.configuraciones.menus.listar'),
                method: 'POST',
            ...
            columns: [
                ...
                {data: 'padre', className: 'text-center'},
                {data: 'visible_span', className: 'text-center'},
    ...
    eventos = () => {
        $('#tabla-data').on("click", 'button.editar', (e) => {
            ...
            let id =$(e.currentTarget).attr('data-id'),
                tipo ="Editar Modulo",
                form = $('<form action="'+route('panel.configuraciones.menus.formulario-menu')+'" method="POST">'+
