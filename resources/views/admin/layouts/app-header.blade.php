    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="{{ route('dashboard') }}">
                <img src="{{ asset('web/images/LOGO-extranet.png') }}" class="header-brand-img desktop-logo" alt="logo" style=" width: 75px; ">
                <img  src="{{ asset('web/images/LOGO-extranet.png') }}" class="header-brand-img light-logo1"
                    alt="logo" style=" width: 75px; ">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-flex profile-1">
                                ...
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    {{-- <img src="{{ asset('template/images/users/21.jpg') }}" alt="profile-user" class="avatar  profile-user brround cover-image"> --}}
                                    <span class="avatar avatar-md brround bg-success">
                                        {{substr(explode(' ',Auth::user()->nombre_corto)[0], 0, 1).substr(explode(' ',Auth::user()->nombre_corto)[1], 0, 1)}}
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="{{ route('configuraciones.dashboard') }}">
