            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                            <div class="text-center">
                                <a href="{{ route('web') }}"><img src="{{ asset('web/images/LOGO-extranet.png')}}" class="header-brand-img" alt="" style=" width: 75px; "></a>
                            </div>
                                        ...
                                        <div class="tab-pane active" id="tab5">
                                            <form method="POST" action="{{route('session-login')}}">
                                                ...
                                                <div class="container-login100-form-btn">
                                                    ...
                                                    <a class="login100-form-btn btn text-dark" href="{{ route('connect') }}">
